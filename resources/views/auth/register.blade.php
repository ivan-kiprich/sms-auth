                    ...
                    <form action="{{route("auth.register.create")}}" method="post" class="page-form__info form">
                        ...
                        <div class="form__wrap">
                            <div class="form__item">
                                <input data-error="Заповніть" data-required data-validate name="name" type="text"
                                       placeholder="Ім'я" class="form__input">
                            </div>
                            <div class="form__item">
                        ...
                        <button type="submit" class="form__button btn">Реєстрація</button>
                        <a href="login.html" class="form__link">Вхід</a>
                    </form>
                </div>
            </div>
        </section>
